...
async def get_camera_status_queries(session, cameras_info: list[CameraStatusDto], complex_ip: str, complex_port: str, access_token: str) -> list[CameraStatusDto]:
...
async def get_cameras_info(complex_ip: str, complex_port: str, login: str, password: str) -> list[CameraStatusDto]:
    result = []
